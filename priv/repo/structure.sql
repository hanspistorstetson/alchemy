...
--
-- Name: tweets_user_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX tweets_user_id_index ON public.tweets USING btree (user_id);
...
INSERT INTO public."schema_migrations" (version) VALUES (20190405165503), (20190405175111), (20190405185457), (20190412024017);
